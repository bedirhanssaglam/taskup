...
final class AppPadding extends EdgeInsets {
  ...
  const AppPadding.smallHorizontal() : super.symmetric(horizontal: WidgetSizes.spacingXs);

  const AppPadding.normalHorizontal() : super.symmetric(horizontal: WidgetSizes.spacingXl);

  const AppPadding.smallVertical() : super.symmetric(vertical: WidgetSizes.spacingXxs);

  const AppPadding.mediumVertical() : super.symmetric(vertical: WidgetSizes.spacingS);
