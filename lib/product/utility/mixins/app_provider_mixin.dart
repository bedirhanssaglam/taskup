...
mixin AppProviderMixin<T extends ConsumerStatefulWidget> on ConsumerState<T> {
  AuthService get authService => ref.read(ProductProviderItems.authServiceProvider);

  AppViewModel get appViewModel => ref.read(ProductProviderItems.appStateProvider.notifier);
